...
if($tab=="settings") $page = "account";
if($tab=="my-torrents") $page = "my-torrents";
if($tab=="my-invites") $page = "my-invites";
...
<div class="row">
    ...
    <div class="col-sm-2">
        ...
        <ul class="nav nav-pills nav-stacked">
            <li role="presentation" <?php if($tab=="settings") echo "class='active'"; ?>><a href="?tab=settings">Settings</a></li>
            <li role="presentation" <?php if($tab=="my-torrents") echo "class='active'"; ?>><a href="?tab=my-torrents">My Torrents</a></li>
            <li role="presentation" <?php if($tab=="my-invites") echo "class='active'"; ?>><a href="?tab=my-invites">My Invites</a></li>
        </ul>
    ...
    <div class="col-sm-10">
        ...
        <div>
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#uploading" aria-controls="uploading" role="tab" data-toggle="tab">Uploading</a></li>
            ...
            <div class="tab-content panel-body">
                <div role="tabpanel" class="tab-pane fade in active" id="profile">
                    ...
                    <form method="post" name="edit_site_config" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control selectpicker dropout" name="country" id="country">
                                    <?php foreach($countries as $k => $v) { ?>
                                    <option data-thumbnail="http://icons.iconarchive.com/icons/tinylab/android-lollipop-apps/24/Dropbox-icon.png"><?= $v ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                ...
                <div role="tabpanel" class="tab-pane fade in" id="uploading">Uploading</div>
                <div role="tabpanel" class="tab-pane fade in" id="display">Display</div>
                <div role="tabpanel" class="tab-pane fade in" id="password">Password</div>
            </div>

        </div>

        <?php } elseif($tab=="my-torrents") { ?>

        <?php } elseif($tab=="my-invites") { ?>
